...
<body>
    <div class="container-fluid">
        ...
        <a class="btn btn-danger logout" href="logout.php" role="button">LogOut</a> | <a class="btn btn-warning" href="cetak.php" role="button" target="blank">Cetak</a>
        ...
        <form class="form-inline mt-2" action="" method="POST">
            ...
            <img src="img/tenor.gif" class="loader">
        </form>
